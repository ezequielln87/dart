...
class DataTableDemoState extends State<DataTableDemo> {
  ...
  _getEmployees() {
    _showProgress('Carregando Dados...');
  ...
  _updateEmployee(Employee employee) {
    ...
    _showProgress('Atualizando dados...');
  ...
  _deleteEmployee(Employee employee) {
    _showProgress('Apagando registro...');
    ...
    return Padding(
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          hintText: 'Filtro pelo primeiro ou último nome',
        ),
        onChanged: (string) {
